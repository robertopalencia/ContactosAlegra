...
Ext.define('Alegra.view.Grid', {
        ...
        handler: function(grid, rowIndex, colIndex) {
          ...
          let store = grid.getStore();
      		Ext.Msg.show({
      			...
      			msg: '¿Estás seguro de que deseas eliminar este contacto?',
  ...
  initComponent: function() {
    ...
    },
    {
      ...
      handler: function(){ Ext.create('Alegra.view.Help').Show();}
